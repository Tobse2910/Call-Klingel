...
namespace CallKlingel.Infrastructure.Logging;

/// <summary>
/// Structured logging to logs/callklingel-yyyy-MM-dd.log.
///
...
public static class AppLog
{
    ...
    public static void Initialize(string? baseDirectory = null, bool debug = false)
    {
        ...
        Log.Logger = new LoggerConfiguration()
            ...
            .WriteTo.File(
                path: Path.Combine(LogDirectory, "callklingel-.log"),
        ...
        Log.Information("Call Klingel gestartet. Logverzeichnis: {LogDirectory}", LogDirectory);
    }
